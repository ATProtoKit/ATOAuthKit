...
public struct ClientMetadata: Codable {
    ...
    public init(
        ...
        tokenEndpointAuthSigningAlgorithm: String? = nil,
        userInfoSignedResponseAlgorithm: String? = nil,
        userInfoEncryptedResponseAlgorithm: String? = nil,
        jwksURI: URI.WebURI? = nil,
        jwks: JSONWebKeyContainer? = nil,
        applicationType: ApplicationType? = .web,
        subjectType: SubjectType? = .public,
        requestObjectSigningAlgorithm: String? = nil,
        idTokenSignedResponseAlgorithm: String? = nil,
        authorizationSignedResponseAlgorithm: String? = "RS256",
        authorizationEncryptedResponseEncoding: String? = "A128CBC-HS256",
        authorizationEncryptedResponseAlgorithm: String? = nil,
        clientID: OAuthClientID? = nil,
        clientName: String? = nil,
        clientURI: URI.WebURI? = nil,
        policyURI: URI.WebURI? = nil,
        termsOfServiceURI: URI.WebURI? = nil,
        logoURI: URI.WebURI? = nil,
        defaultMaxAge: Int? = nil,
        isAuthTimeRequired: Bool? = nil,
        contacts: [String]? = nil,
        isTLSClientCertificateBoundAccessTokens: Bool? = nil,
        isDPoPBoundAccessTokens: Bool? = nil,
